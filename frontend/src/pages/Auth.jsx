        ...
        {/* main row */}
            {
              ...
              <div className="col-lg-6 col-sm-12 right-div">
                  <div className="input-div d-flex flex-column align-items-center pt-3">
                      ...
                      <input placeholder=' email' className='mt-2 form-control' type="text" />
                      <input placeholder=' password' className='mt-2 form-control' type="text" />
          ...
          <div className="col-6 right-div">
              <div className="input-div d-flex flex-column align-items-center pt-3">
                  <h3>LOGIN </h3>
                  <input placeholder=' email' className='mt-4 form-control' type="text" />
                  <input placeholder=' password' className='mt-2 form-control' type="text" />
